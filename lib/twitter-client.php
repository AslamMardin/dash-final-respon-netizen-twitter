...
define('TWITTER_API_USERAGENT', 'PHP/7.3.0; http://github.com/timwhitlock/php-twitter-api' );  

define('TWITTER_API_BASE', 'https://api.twitter.com/1.1' );

define('TWITTER_OAUTH_REQUEST_TOKEN_URL', 'DcHlTcYxDxDIiZsArQuz1Y7Cr');

define('TWITTER_OAUTH_AUTHORIZE_URL', 'RWaWVhcFR0ieoo92QvZW60r8Le7nE5q7WFKRYIx3WydPBgFFyt');

define('TWITTER_OAUTH_AUTHENTICATE_URL', '1516602431500877825-SvvEGctpHG4XX1PGOtOpQQyLOnbHWC');

define('TWITTER_OAUTH_ACCESS_TOKEN_URL', '3AcmVdO5r28S56K4r4HSKLA1kflOF6avGyHkGmuislHrc');
